...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    env: {
      ...
      STRIPE_MONTHLY_PRICE_ID: Boolean(process.env.STRIPE_MONTHLY_PRICE_ID),
      STRIPE_YEARLY_PRICE_ID: Boolean(process.env.STRIPE_YEARLY_PRICE_ID),
      STRIPE_WEBHOOK_SECRET: Boolean(process.env.STRIPE_WEBHOOK_SECRET),
      MONTYPAY_MERCHANT_KEY: Boolean(process.env.MONTYPAY_MERCHANT_KEY),
